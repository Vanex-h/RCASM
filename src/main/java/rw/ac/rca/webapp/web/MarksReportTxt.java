...
public class MarksReportTxt extends HttpServlet {
    ...
    MarksDAO markDAO = MarksDAOImpl.getInstance();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(pageRedirect.equals("markstxt")){
            ...
            List<Marks> marks = markDAO.getAllMarks();
            if(marks != null){
                ...
                try (OutputStream fos  = new FileOutputStream(file)){
                    for (Marks marks1: marks){
                        String marksScored = "Marks Scored: " + marks1.getScore();
...
//                        fos.write(grade.getBytes());
                ...
                outputStream.close();
                RequestDispatcher dispatcher = req.getRequestDispatcher("WEB-INF/listMarks.jsp");
